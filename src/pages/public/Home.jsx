          ...
          <div style={styles.hero}>
            <Container>
              <Row className="align-items-center">
                <Col lg={6}>
                  <h1 style={styles.heroTitle}>Global Track Cargo</h1>
            ...
            <Col md={3} sm={6}>
              <Card style={styles.statsCard}>
                <Card.Body>
                  ...
                  {statsLoading ? (
                    <div className="spinner-border text-primary" role="status" style={{ margin: '8px auto' }}>
                      <span className="visually-hidden">Loading...</span>
                    </div>
                  ) : (
                    <h3 style={styles.statsNumber}>{stats.total}</h3>
                  )}
            ...
            <Col md={3} sm={6}>
              <Card style={styles.statsCard}>
                <Card.Body>
                  ...
                  {statsLoading ? (
                    <div className="spinner-border text-success" role="status" style={{ margin: '8px auto' }}>
                      <span className="visually-hidden">Loading...</span>
                    </div>
                  ) : (
                    <h3 style={styles.statsNumber}>{stats.delivered}</h3>
                  )}
            ...
            <Col md={3} sm={6}>
              <Card style={styles.statsCard}>
                <Card.Body>
                  ...
                  {statsLoading ? (
                    <div className="spinner-border text-warning" role="status" style={{ margin: '8px auto' }}>
                      <span className="visually-hidden">Loading...</span>
                    </div>
                  ) : (
                    <h3 style={styles.statsNumber}>{stats.in_transit}</h3>
                  )}
            ...
            <Col md={3} sm={6}>
              <Card style={styles.statsCard}>
                <Card.Body>
                  ...
                  {statsLoading ? (
                    <div className="spinner-border text-danger" role="status" style={{ margin: '8px auto' }}>
                      <span className="visually-hidden">Loading...</span>
                    </div>
                  ) : (
                    <h3 style={styles.statsNumber}>{stats.pending}</h3>
                  )}
      ...
      <Container>
        <div style={styles.sectionBorderYellow}>
          <div style={styles.ctaSection}>
            <Container>
              <h2 style={{ marginBottom: '8px' }}>🚀 Ready to Ship?</h2>
              <p style={{ opacity: 0.8, marginBottom: '20px', fontSize: '1.1rem' }}>
